...
Choices.prototype.checkSelectChoicesByValue = function (value) {
  ...
  choiceValue.map(val => {
    if (!check)
      check = this._checkSelectChoiceByValue(val);
  });
  return check;
};

Choices.prototype._checkSelectChoiceByValue = function (value) {

  let choices = this._store.choices; // Check 'value' property exists and the choice isn't already selected
  let foundChoice = choices.find((choice) => choice.value === value);

  return foundChoice && foundChoice.selected;
}